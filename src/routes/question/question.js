      ...
      <View>
        <View className="question-wrp">
          <View className="question-item">
            ...
            <View className="que-title">选择 Kindle 而不是纸质书的原因是什么？</View>
            <View className="que-content">WEB前端*不靠谱天气预报员*想做代码小仙女</View>
          ...
          <View className="feed-item">
            ...
            <View className="feed-content">
              <View className="answer-body">
                <View onClick={this.navigateTo.bind(this, '/routes/answer/answer')}>
