...
var _TaroComponentClass = function (_BaseComponent) {
  ...
  function _TaroComponentClass() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _TaroComponentClass.__proto__ || Object.getPrototypeOf(_TaroComponentClass)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["data"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
